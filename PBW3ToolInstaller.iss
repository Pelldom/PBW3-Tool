...
#define MyAppExeName "PBW3 Tool.exe"
...
[Files]
Source: "dist\PBW3 Tool.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\PBW3 Tool"; Filename: "{app}\PBW3 Tool.exe"; WorkingDir: "{app}"; IconFilename: "{app}\Resources\PBW3.ico"
Name: "{commondesktop}\PBW3 Tool"; Filename: "{app}\PBW3 Tool.exe"; WorkingDir: "{app}"; IconFilename: "{app}\Resources\PBW3.ico"; Tasks: desktopicon

[Tasks]
Name: "desktopicon"; Description: "Create a &desktop icon"; GroupDescription: "Additional icons:"

[Run]
Filename: "{app}\PBW3 Tool.exe"; Description: "Launch PBW3 Tool"; Flags: nowait postinstall skipifsilent
